...
extern CString GetAppDataPath();
extern BOOL FileExist(const CString& rFilePath);
...
#ifdef _UNICODE
#define	AUTOUP_DLL	_T("AutoUpU.dll")
#pragma comment(lib, "Htmlhelp.Lib")
#else
#define	AUTOUP_DLL	_T("AutoUp.dll")
#pragma comment(lib, "Htmlhelp.Lib")
#endif

#define APPNAME	_T("SmartReporter")
