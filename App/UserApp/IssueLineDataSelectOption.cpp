// IssueLineDataSelectOption.cpp : implementation file
//
...
const int CIssueLineDataSelectOption::WIDTH = 230;
/////////////////////////////////////////////////////////////////////////////
// CIssueLineDataSelectOption dialog


CIssueLineDataSelectOption::CIssueLineDataSelectOption(CWnd* pParent /*=NULL*/)
	: CDialog(CIssueLineDataSelectOption::IDD, pParent) , /*m_pPropTreeCtrl(NULL) , */m_pTargetWnd(NULL)
{
	//{{AFX_DATA_INIT(CIssueLineDataSelectOption)
	//}}AFX_DATA_INIT
	m_pBoldFont = NULL;
...
CIssueLineDataSelectOption::~CIssueLineDataSelectOption()
{
	try
	{
...
void CIssueLineDataSelectOption::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CIssueLineDataSelectOption)
...
BEGIN_MESSAGE_MAP(CIssueLineDataSelectOption, CDialog)
	//{{AFX_MSG_MAP(CIssueLineDataSelectOption)
...
/////////////////////////////////////////////////////////////////////////////
// CIssueLineDataSelectOption message handlers

BOOL CIssueLineDataSelectOption::OnInitDialog() 
{
	...
	((CButton*)GetDlgItem(IDC_CHECK_ISSUE_DATE))->EnableWindow(FALSE);
...
/**
	...
	@author	humkyung
*/
void CIssueLineDataSelectOption::OnButtonSelectAll() 
{
	NMHDR hdr;
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::OnCheckIssueDate() 
{
...
/**	
	...
	@return	void
*/
void CIssueLineDataSelectOption::InitContents( CWnd* pTargetWnd )
{
...
/******************************************************************************
    @author     humkyung
    @date       2011-10-29
    @class      CIssueLineDataSelectOption
    @function   OnSize
    @return     void
    @param      UINT    nType
    @param      int     cx
    ...
    @brief
******************************************************************************/
void CIssueLineDataSelectOption::OnSize(UINT nType, int cx, int cy) 
{
...
void CIssueLineDataSelectOption::OnDestroy()
{
	CDialog::OnDestroy();
}
...
/**	
	...
	@return	void
*/
void CIssueLineDataSelectOption::OnButtonSelect() 
{
...
/**	
	...
	@return	CString	
*/
CString CIssueLineDataSelectOption::GetQueryCondition() const
{
...
/**	
	...
	@return	const char*	
*/
void CIssueLineDataSelectOption::GetSelectedIssueDate(vector<STRING_T>& issueDates )
{
	issueDates.clear();
...
*/
CString CIssueLineDataSelectOption::GetSelectedRevNo() const
{
	CString rString("");
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::OnUpdateSelectionTreeList(bool bReload)
{
	CAppDocData* pDocData = CAppDocData::GetInstance();
	...
	try
	{
		...
		CString sSql = _T("SELECT DISTINCT PLANT_NO,AREA_NO,UNIT_NO,SECTION_NO FROM T_ISSUED_ISO_LINE_DATA");
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
bool CIssueLineDataSelectOption::AreAllItemsChecked(HTREEITEM hItem)
{
...
/******************************************************************************
    ...
    @brief
******************************************************************************/
int CIssueLineDataSelectOption::GetCheckedItemList( vector< STRING_T >& oCheckedList , HTREEITEM hItem)
{
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::GetSelPlantNos( vector< STRING_T >& oPlantNos )
{
	oPlantNos.clear();
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::GetSelAreaNos( vector< STRING_T >& oAreaNos , const STRING_T& sPlantNo)
{
	oAreaNos.clear();
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::GetSelUnitNos( vector< STRING_T >& oUnitNos , const STRING_T& sPlantNo , const STRING_T& sAreaNo )
{
	oUnitNos.clear();
...
/**	
	...
	@return	void	
*/
void CIssueLineDataSelectOption::GetSelSectionNos( vector< STRING_T >& oSectionNos , const STRING_T& sPlantNo , const STRING_T& sAreaNo , const STRING_T& sUnitNo )
{
	oSectionNos.clear();
...
/**	
	@brief	The CIssueLineDataSelectOption::UpdateRevNoComboBox function
	@author	humkyung
	@return	void	
*/
void CIssueLineDataSelectOption::OnUpdateRevNoComboBox(bool bReload)
{
...
/**
	...
	@author	humkyung
**/
void CIssueLineDataSelectOption::SetEnableSelectButton()
{
...
/**
	...
	@author	HumKyung.BAEK
**/
CString CIssueLineDataSelectOption::GetInAreaQueryCondition() const
{
	CAppDocData* pDocData = CAppDocData::GetInstance();
...
/**	
	...
	@author	humkyung
**/
bool CIssueLineDataSelectOption::CheckIssueDateToQuery() const
{
...
/**
	...
	@author	humkyung
**/
void CIssueLineDataSelectOption::UpdateSelectionTreeList(bool bReload , CIssueLineDataSelectOption* pTarget)
{
...
/**
	...
	@author	humkyung
**/
void CIssueLineDataSelectOption::UpdateRevNoComboBox(bool bReload , CIssueLineDataSelectOption* pTarget)
{
