...
CAppPostgreSQL::CAppPostgreSQL(const CString& sDatabase,const CString& sUser,const CString& sPassword,const CString& sHost)
{
...
/**
	@brief	execute given query string and then store to rowset
	@author	humkyung
	@date	2015.09.30
*/
//soci::rowset<soci::row> CAppPostgreSQL::ExecuteRowSet(const CString& sql)
//{
//	try
//	{
//		soci::session database(*soci::factory_postgresql() , GetConnectionString().operator LPCTSTR());
//		return (database.prepare << sql.operator LPCTSTR());
//	}
//	catch(const exception& ex)
//	{
//		int d = 1;
