...
public:
	...
	int Reset();
	int DisplayDataOf(list<CLineDataRecord*>& oLineDataRecordList,const BOOL& isEditable=TRUE);
protected:
...
private:
	list<CLineDataRecord*> m_oLineDataRecordList;	/// 2013.02.07 added by humkyung
};
